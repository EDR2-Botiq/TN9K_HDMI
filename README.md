...
| `clk_tmds_serial` | 125.875 MHz | TMDS serialization (exact HDMI rate) |
| `clk_pixel` | 25.175 MHz | HDMI pixel clock (125.875/5) |
...
│   │   ├── gowin_tmds_rpll.vhd           # 125.875 MHz TMDS PLL
│   │   ├── gowin_tmds_rpll.ipc           # PLL IP configuration
│   │   ├── gowin_hdmi_clkdiv.vhd         # 25.175 MHz pixel clock divider
...
The 125.875 MHz and 25.175 MHz clocks maintain exact 5:1 ratio via hardware divider.
